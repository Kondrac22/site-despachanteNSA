...
import HistoryFilters from "@/components/prestacao-servicos/HistoryFilters";
...
export default async function HistoricoPage({
  ...
  function pageHref(targetPage: number) {
    ...
    return `/prestacao-servicos/historico?${query.toString()}`;
  }
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                {entry.service_requests && (
                  <Link
                    href={`/prestacao-servicos/servicos/${entry.service_requests.id}`}
