...
export default function ServicosPage() {
  const services = [
    ...
    },
    {
      ...
      documents: [
        "ATPV/CRV (Certificado de Registro do Veículo) original",
        "CRLV (Certificado de Registro e Licenciamento)",
        "RG ou CNH do comprador",
        "Comprovante de residência",
        "Laudo de vistoria ECV",
        "Se pessoa jurídica, contrato social e RG/CNH do representante",
      ],
      estimatedTime: "3 a 4 dias úteis",
      pricing: "Consulte-nos para valores",
    },
    {
    ...
    },
    {
      ...
      documents: [
        "Notas fiscais do veículo",
        "RG ou CNH do proprietário",
        "Comprovante de residência",
        "RENAVE fornecido pela concessionária",
      ],
    ...
    },
    {
      ...
      documents: [
        ...
        "Dados para o preenchimento do ATPV",
      ],
      estimatedTime: "Imediato",
      pricing: "Consulte-nos para valores",
    },
    {
      ...
      documents: [
        "CRV e CRLV originais (se houver)",
        "Laudo de vistoria técnica Inmetro e vistoria veicular ECV",
        "Nota fiscal das peças instaladas e nota fiscal de serviço",
        "RG ou CNH do proprietário",
        "Comprovante de residência",
      ],
    ...
    },
    {
      ...
      estimatedTime: "4 a 5 dias úteis",
      pricing: "Consulte-nos para valores",
    },
    {
      ...
      estimatedTime: "5 a 6 dias úteis",
      pricing: "Consulte-nos para valores",
    },
  ];
